      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f1e9ea] px-10 py-3">
        ...
        <div className="flex flex-1 justify-end gap-8">
          <div className="flex items-center gap-9">
            <a className="text-[#191011] text-sm font-medium leading-normal" href="#">Enterprise</a>
            <a className="text-[#191011] text-sm font-medium leading-normal" href="#">Pricing</a>
            <a className="text-[#191011] text-sm font-medium leading-normal" href="#">Resources</a>
          </div>
          <div className="flex gap-2">
            <button
              className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#be3144] text-[#fbf9f9] text-sm font-bold leading-normal tracking-[0.015em]"
            >
