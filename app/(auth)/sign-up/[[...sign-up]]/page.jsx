      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: 'url("https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80")'
            }}
          ></div>
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
            <div className="max-w-md">
              ...
              <p className="text-lg leading-relaxed text-white/90 mb-8">
                Start your journey with AI-powered interview preparation. Get personalized feedback, track your progress, and land your dream job.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/90">Free AI interview practice</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white/90">Real-time performance insights</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white/90">Smart job matching</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <span className="text-white/90">Professional CV analysis</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-8 lg:px-12 lg:py-0 min-h-screen">
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden text-center mb-8">
              ...
              <p className="text-[#191011]/70 leading-relaxed">
                Start your AI-powered interview journey and unlock your potential
              </p>
            </div>
              ...
              <SignUp 
                appearance={{
                  elements: {
                    ...
                    identityPreviewEditButton: "text-[#be3144] hover:text-[#f05941] font-medium transition-colors duration-300",
                    formResendCodeLink: "text-[#be3144] hover:text-[#f05941] font-medium transition-colors duration-300"
                  }
                }}
              />
            </div>
            ...
            <div className="lg:hidden text-center mt-8">
              <p className="text-[#191011]/60 text-sm">
                ...
                <Link href="/sign-in" className="text-[#be3144] hover:text-[#f05941] font-medium transition-colors duration-300">
                  Sign in here
                </Link>
              </p>
            </div>
