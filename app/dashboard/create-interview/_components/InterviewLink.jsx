        ...
        <div className='flex flex-col items-center justify-center mt-10'>
            ...
            <div className='w-full p-7 mt-6 rounded-lg bg-white'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <h2 className='p-1 px-2 text-primary bg-red-100 rounded-full'>Valid for 30 Days</h2>
                </div>
            ...
            <div className='mt-7 bg-white p-5 rounded-lg w-full'>
                ...
                <div className='flex gap-7 mt-2'>
                    ...
                    <Button variant={'outline'} className='w-full'> <Slack /> Slack </Button>
                    <Button variant={'outline'} className='w-full'> <Phone /> Whatsapp </Button>
                </div>
            </div>
            ...
            <div className='flex w-full gap-5 justify-between mt-6'>
                ...
                <Button> <Plus/> Create New Job</Button>
                </Link>
